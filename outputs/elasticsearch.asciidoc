...
* https://github.com/logstash-plugins/logstash-output-elasticsearch/blob/master/CHANGELOG.md#722[Changelog]
...
The following configuration options are supported by the elasticsearch output
